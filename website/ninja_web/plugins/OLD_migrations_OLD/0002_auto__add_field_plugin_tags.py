...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Plugin.tags'
        db.add_column('plugins_plugin', 'tags', self.gf('tagging.fields.TagField')(default=''), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Plugin.tags'
        db.delete_column('plugins_plugin', 'tags')
